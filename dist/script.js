...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modulePageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.moduleapp',
    btns: 'a.next',
    prevPageLink: 'div.prev',
    nextPageLink: 'div.next'
  });
  ...
  var difference = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]({
  ...
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info-show', '.msg').init();
    ...
    value: function init() {
      ...
      try {
        this.trigger.addEventListener('click', function () {
          _this.content.classList.toggle('msg');

          _this.content.style.marginTop = '20px';
        });
      } catch (e) {}
    }
  }]);
...
function () {
  function Difference(_ref) {
    var oldOfficer = _ref.oldOfficer,
        newOfficer = _ref.newOfficer,
        items = _ref.items;
...
function () {
  function Form(forms) {
    ...
    this.message = {
      ...
      success: 'С Вами свяжутся в ближайшее время.',
      failure: 'Произошла ошибка при загрузке.'
    };
      ...
      if (this.btns.length > 0) {
        this.btns.forEach(function (btn) {
          btn.addEventListener('click', function (e) {
            if (!(e.target.closest('.closed') && e.target.closest('.closed').classList.contains('closed'))) {
              _this.activeBtn = btn;
      ...
      try {
        ...
        if (state.data === 0) {
          if (blockedElem.querySelector('.play__circle').classList.contains('closed')) {
            ...
            blockedElem.classList.remove('attention');
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
      ...
      try {
        ...
        if (n == 3) {
          this.timeout = setTimeout(function () {
            _this.hanson.classList.add('animated', 'fadeIn');
    ...
    value: function bindTriggers() {
      ...
      this.prevPageLink.forEach(function (item) {
      ...
      this.nextPageLink.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      if (this.slides[1].tagName == "BUTTON" && this.slides[2].tagName == "BUTTON") {
        ...
        this.container.appendChild(this.slides[1]); // Slide
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$nextPageLink = _ref.nextPageLink,
      nextPageLink = _ref$nextPageLink === void 0 ? null : _ref$nextPageLink,
      _ref$prevPageLink = _ref.prevPageLink,
      prevPageLink = _ref$prevPageLink === void 0 ? null : _ref$prevPageLink,
  ...
  this.activeClass = activeClass, this.animate = animate, this.autoPlay = autoPlay, this.slideIndex = 1;
};
